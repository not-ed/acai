...
namespace AcaiCore
{
    public class FoodItemShortcutMacronutrientsSchema : IJournalTableSchema
    {
        private readonly string creationQuery = "ALTER TABLE food_item_shortcuts ADD COLUMN protein REAL;" + 
