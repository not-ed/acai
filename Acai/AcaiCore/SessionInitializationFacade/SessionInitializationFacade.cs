...
namespace AcaiCore
{
    public class SessionInitializationFacade : ISessionInitializationFacade
    {
        ...
        public bool InitializeSessionFromNewJournalFileAtPath(string journalFilePath)
        {
            ...
            _session = new AcaiSession(new FoodItemGateway(_sqliteConnectionFactory), new FoodItemShortcutGateway(_sqliteConnectionFactory), new FoodJournalNoteGateway(_sqliteConnectionFactory), new WeightJournalGateway(_sqliteConnectionFactory));
